                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-muted">The GDPR is a regulation that requires businesses to
                                            protect the personal data and privacy of Europe citizens for transactions that
                                            occur within EU member states.</p>
                                    </td>
                                    <td class="td-actions text-right">
                                        <button type="button" rel="tooltip" title="" class="btn btn-link"
                                            data-original-title="Edit Task">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/tania.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        Tania Mike
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/robi.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        John Doe
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/lora.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        Alexa Mike
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/jana.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        Jana Monday
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button type="button" rel="tooltip" class="btn btn-danger btn-link btn-sm btn-icon"
                                            data-original-title="Tooltip on top" title="Delete">
                                            <i class="tim-icons icon-simple-remove"></i>
                                        </button>
                                    </td>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/mike.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        Paul Dickens
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="photo">
                                            <img src="admin/assets/img/emilyz.jpg" alt="photo">
                                        </div>
                                    </td>
                                    <td>
                                        Manuela Rico
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/US.png" alt="flag">
                                                </div>
                                            </td>
                                            <td>USA</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/DE.png" alt="flag">
                                                </div>
                                            </td>
                                            <td>Germany</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/AU.png" alt="flag">
                                                </div>
                                            </td>
                                            <td>Australia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/GB.png" alt="flag">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/RO.png" alt="flag">
                                                </div>
                                            </td>
                                            <td>Romania</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="admin/assets/img/BR.png" alt="flag">
                                                </div>
                                            </td>
                                            <td>Brasil</td>
                                            <td class="text-right">
