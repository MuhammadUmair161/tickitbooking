...
@section('main')
    <!-- ==========Banner-Section========== -->
    <section class="details-banner hero-area bg_img" data-background="{{ asset('storage/' . $movies->poster) }}">
        <div class="container">
        ...
        <div class="container">
            <form class="ticket-search-form two">
                <div class="form-group">
                    <div class="thumb">
                        <img src="{{ asset("user/assets/images/ticket/city.png") }}") }}" alt="ticket">
                    </div>
                ...
                <div class="form-group">
                    <div class="thumb">
                        <img src="{{ asset("user/assets/images/ticket/date.png") }}" alt="ticket">
                    </div>
                ...
                <div class="form-group">
                    <div class="thumb">
                        <img src="{{ asset("user/assets/images/ticket/cinema.png") }}" alt="ticket">
                    </div>
                ...
                <div class="form-group">
                    <div class="thumb">
                        <img src="{{ asset("user/assets/images/ticket/exp.png") }}" alt="ticket">
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-10">
                    <div class="widget-1 widget-banner">
                        <div class="widget-1-body">
                            <a href="#0">
                                <img src="{{ asset("user/assets/images/sidebar/banner/banner03.jpg")}}" alt="banner">
                            </a>
                        </div>
                    </div>
                </div>
