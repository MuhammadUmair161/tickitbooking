...
@section('main')
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="about-thumb">
                        <img src="{{ asset('user/assets/images/about/about01.png') }}" alt="about">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="philosophy-section padding-top padding-bottom bg-one bg_img bg_quater_img"
        data-background="{{ asset('user/assets/images/about/about-bg.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 offset-lg-3 bg-two">
                    <div class="philosophy-content">
                        ...
                        <ul class="phisophy-list">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('user/assets/images/philosophy/icon1.png') }}" alt="philosophy">
                                </div>
                                <h5 class="title">Honesty & Fairness </h5>
                            </li>
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('user/assets/images/philosophy/icon2.png') }}" alt="philosophy">
                                </div>
                                <h5 class="title">Clarity & Transparency</h5>
                            </li>
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('user/assets/images/philosophy/icon3.png') }}" alt="philosophy">
                                </div>
                    ...
                    <div class="about-counter">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('user/assets/images/about/about-counter01.png') }}" alt="about">
                            </div>
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('user/assets/images/about/about-counter02.png') }}" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('user/assets/images/about/about-counter03.png') }}" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="{{ asset('user/assets/images/about/about-counter04.png') }}" alt="about">
                            </div>
                            <div class="counter-content">
    ...
    <!-- ==========Client-Section========== -->
    {{-- <section class="client-section padding-bottom padding-top bg_img" data-background="{{ asset('user/assets/images/client/client-bg.jpg') }}">
        <div class="container">
            ...
            <div class="client-slider owl-carousel owl-theme">
                <div class="client-item">
                    <div class="client-thumb">
                        <img src="{{ asset('user/assets/images/client/client01.jpg') }}" alt="client">
                    </div>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                        <img src="{{ asset('user/assets/images/client/client03.jpg') }}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Rudra</a>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                        <img src="{{ asset('user/assets/images/client/client02.jpg') }}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Raihan</a>
                ...
                <div class="client-item">
                    <div class="client-thumb">
                        <img src="{{ asset('user/assets/images/client/client04.jpg') }}" alt="client">
                    </div>
                    <div class="client-content">
                        <h5 class="title">
                            <a href="#0">Shahidul</a>
            ...
            <div class="speaker--slider">
                <div class="speaker-slider owl-carousel owl-theme">
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                <img src="{{ asset('user/assets/images/speaker/speaker01.jpg') }}" alt="speaker">
                            </a>
                        </div>
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                <img src="{{ asset('user/assets/images/speaker/speaker02.jpg') }}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                <img src="{{ asset('user/assets/images/speaker/speaker03.jpg') }}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                    ...
                    <div class="speaker-item">
                        <div class="speaker-thumb">
                            <a href="event-speaker.html">
                                <img src="{{ asset('user/assets/images/speaker/speaker04.jpg') }}" alt="speaker">
                            </a>
                        </div>
                        <div class="speaker-content">
                            <h5 class="title">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery05.jpg') }}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery06.jpg') }}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery07.jpg') }}" alt="gallery">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 order-lg-1">
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery11.jpg') }}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery12.jpg') }}" alt="gallery">
                        </div>
                    </div>
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery13.jpg') }}" alt="gallery">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="gallery-item two">
                        <div class="gallery-thumb">
                            ...
                            <img src="{{ asset('user/assets/images/gallery/gallery08.jpg') }}" alt="gallery">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="gallery-item two">
                                <div class="gallery-thumb">
                                    ...
                                    <img src="{{ asset('user/assets/images/gallery/gallery09.jpg') }}" alt="gallery">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="gallery-item two">
                                <div class="gallery-thumb">
                                    ...
                                    <img src="{{ asset('user/assets/images/gallery/gallery10.jpg') }}" alt="gallery">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tour-content">
                        ...
                        <ul class="list-tour">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('user/assets/images/tour/icon01.png') }}" alt="tour">
                                </div>
                                <div class="content">
                            ...
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('user/assets/images/tour/icon02.png') }}" alt="tour">
                                </div>
                                <div class="content">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="tour-thumb">
                        <img src="{{ asset('user/assets/images/tour/tour.png') }}" alt="tour">
                    </div>
                </div>
            </div>
        </div>
